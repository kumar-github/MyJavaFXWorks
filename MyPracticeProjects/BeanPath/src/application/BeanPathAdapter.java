    ...
    protected static class FieldProperty<BT, T> extends ObjectPropertyBase<String> {
        ...
        public void set(final String v) {
            try {
                ...
                //final Object val = FieldStringConverter.coerce(v, cv != null ? cv.getClass() : fieldHandle.getFieldType());
                final Object val;
                if(cv != null)
                {
                	val = FieldStringConverter.coerce(v, cv.getClass());
                }
                else
                {
                	val = FieldStringConverter.coerce(v, fieldHandle.getFieldType());
                }
