...
public class MainWindowControllerNew_BACKUP_ON_02_06_2016 implements Initializable
{
    ...
    public MainWindowControllerNew_BACKUP_ON_02_06_2016()
    {
    ...
    */
	...
	public List<DummyExternalTrade> fetchExternalTradesFromDBForTableView()
	{
		...
		FetchExternalTradesScheduledService fetchExternalTradesScheduledService = new FetchExternalTradesScheduledService();
		statusBar.progressProperty().bind(fetchExternalTradesScheduledService.progressProperty());
		statusBar.textProperty().bind(fetchExternalTradesScheduledService.messageProperty());
		
		fetchExternalTradesScheduledService.setPeriod(Duration.seconds(10));
		fetchExternalTradesScheduledService.start();
