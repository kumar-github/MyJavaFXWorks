...
public class Main extends Application {
    ...
    public void start(Stage primaryStage)
    {
        ...
        HBox buttons = new HBox(10, runOnFXThreadButton, runInTaskButton, pbar, pindicator);
        ...
        runInTaskButton.setOnAction(event -> {
            ...
            task.messageProperty().addListener((obs, oldMessage, newMessage) -> pbar.progressProperty()); 
            task.messageProperty().addListener((obs, oldMessage, newMessage) -> pindicator.progressProperty());
