...
import application.EmployeeType;
...
//    private static Integer MAX_HISTORY = 100;
    ...
    public Person() {
        ...
        this.employeeTypeProperty = new SimpleObjectProperty<EmployeeType>(this, "employeeType", EmployeeType.FULL_TIME);
    ...
    private final ObjectProperty<EmployeeType> employeeTypeProperty;
    public final ObjectProperty<EmployeeType> employeeTypeProperty() { return employeeTypeProperty; }
    public final EmployeeType getEmployeeType() { return employeeTypeProperty.get(); }
    public final void setEmployeeType(EmployeeType type) { employeeTypeProperty.set(type); }
    ...
    public Person(String firstName, String lastName, boolean telecommuter, double balance) {
        ...
        int employeeTypePos = new Random().nextInt(EmployeeType.values().length);
        setEmployeeType(EmployeeType.values()[employeeTypePos]);
