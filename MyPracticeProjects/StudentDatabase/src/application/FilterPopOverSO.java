Problem solved. The garbage collector was removing the listeners every time the popover was hidden. 
I simply moved the 'add listener' statement to the point where I showed the popover.
