...
public class TradeEntryDateCellValueFactory implements Callback<TableColumn.CellDataFeatures<DummyExternalTrade, ZonedDateTime>, ObservableValue<ZonedDateTime>>
{
	@Override
