...
public class TradeCreationDateCellValueFactory implements Callback<TableColumn.CellDataFeatures<DummyExternalTrade, ZonedDateTime>, ObservableValue<ZonedDateTime>>
{
	@Override
